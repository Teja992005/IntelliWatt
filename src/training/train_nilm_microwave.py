...
def main():
    print("=== TRAIN_NILM_MICROWAVE STARTED ===")

    # --------------------------------------------------
    # Load microwave-specific data
    # --------------------------------------------------
    X = np.load("data/processed/X_microwave.npy")
    y = np.load("data/processed/y_microwave.npy")

    print("Loaded microwave data")
    ...
    joblib.dump(scaler, "src/models/nilm_microwave_scaler.pkl")
    print("Microwave scaler saved")

    # --------------------------------------------------
    # Build model (microwave needs strong filters)
    # --------------------------------------------------
    ...
    plt.xlabel("Epoch")
    plt.ylabel("MSE Loss")
    plt.title("Microwave Training Loss Curve")
    plt.legend()
    plt.savefig("reports/microwave_loss_curve.png")
    plt.close()

    print("Saved: reports/microwave_loss_curve.png")

    # --------------------------------------------------
    # Evaluation
    # --------------------------------------------------
    print("\nEvaluating MICROWAVE NILM model...")
    ...
    plt.title("Microwave NILM Metrics")
    plt.ylabel("Value")
    plt.savefig("reports/microwave_metrics.png")
    plt.close()

    print("Saved: reports/microwave_metrics.png")
    ...
    print("=== TRAIN_NILM_MICROWAVE COMPLETED ===")
